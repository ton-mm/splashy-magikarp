...
public class Pipedown extends Base{
	...
	public Pipedown(int posX,int posY){
		super(posX,posY);
                Image pipe1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("Imagenes/pipedown.png"));
                /*
